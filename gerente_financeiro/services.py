...
def _categorizar_com_mapa_inteligente(texto: str, tipo_transacao: str, db: Session) -> Tuple[Optional[int], Optional[int]]:
    ...
    MAPA_CATEGORIZACAO = {
        ...
        'Alimentação': {
            ...
            'Restaurante/Delivery': ['restaurante', 'churrascaria', 'pizzaria', 'jantar', 'ifood', 'rappi', 'uber eats', 'delivery'],
            'Padaria e Lanches': ['padaria', 'panificadora', 'lanche', 'cafe', 'starbucks'],
            'Bares e Vida Noturna': ['bar', 'pub', 'balada'],
        },
        'Transporte': {
            'Combustível': ['posto', 'gasolina', 'etanol', 'combustivel', 'shell', 'ipiranga'],
            'App de Transporte': ['uber', '99app', '99'],
            'Estacionamento/Pedágio': ['estacionamento', 'estapar', 'zona azul', 'pedagio'],
            'Transporte Público': ['metro', 'cptm', 'onibus', 'bilhete unico'],
            'Manutenção Veicular': ['oficina', 'revisao', 'mecanico'],
            'Seguro/IPVA': ['ipva', 'seguro'],
        },
        'Moradia': {
            'Aluguel/Prestação': ['aluguel', 'prestacao'],
            'Condomínio': ['condominio'],
            'Contas (Luz/Água/Gás)': ['energia', 'eletropaulo', 'enel', 'sabesp', 'agua', 'luz', 'comgas'],
            'Internet/TV': ['internet', 'net virtua', 'claro', 'tv'],
            'Manutenção/Reforma': ['manutencao', 'reforma'],
            'Móveis/Decoração': ['moveis', 'decoracao'],
        },
        'Saúde': {
            'Farmácia': ['farmacia', 'drogaria', 'drogasil', 'droga raia'],
            'Consultas/Exames': ['medico', 'consulta', 'exame', 'laboratorio', 'hospital'],
            'Plano de Saúde': ['plano de saude', 'convenio'],
            'Academia/Esportes': ['academia', 'esporte'],
        },
        'Lazer e Entretenimento': {
            'Cinema/Streaming': ['netflix', 'spotify', 'disney+', 'hbo max', 'globoplay', 'cinema'],
            'Eventos/Shows': ['ingresso', 'show', 'teatro', 'sympla'],
            'Hobbies': ['steam', 'playstation', 'xbox', 'nuuvem', 'hobby'],
            'Viagens/Turismo': ['viagem', 'hotel', 'airbnb', 'passagem'],
            'Bares e Vida Noturna': ['bar', 'balada', 'pub'],
        },
        'Compras': {
            'Roupas/Acessórios': ['loja de roupa', 'renner', 'cea', 'zara', 'acessorio'],
            'Eletrônicos': ['fast shop', 'ponto frio', 'magazine luiza', 'apple', 'eletron'],
            'Presentes': ['presente'],
            'Itens para Casa': ['utilidades', 'casa'],
            'Casa/Decoração': ['decoracao'],
        },
        'Serviços e Assinaturas': {
            'Assinaturas Digitais': ['assinatura', 'software', 'saas'],
            'Telefone Celular': ['celular', 'telefonia', 'tim', 'vivo', 'claro', 'oi'],
            'Serviços Profissionais': ['contador', 'advogado', 'servico'],
        },
        'Financeiro': {
            'Juros/Encargos': ['juros', 'encargo'],
            'Taxas Bancárias': ['tarifa', 'taxa banc', 'anuidade'],
            'Empréstimos/Financiamentos': ['emprestimo', 'financiamento'],
            'Seguros': ['seguro'],
        },
        'Receitas': {
            'Salário': ['salario', 'pagamento', 'vencimento'],
            'Bônus/13º': ['bonus', '13'],
            'Freelance/Renda Extra': ['freelance', 'renda extra'],
            'Vendas': ['venda'],
        ...
        'Investimentos': {
            'Aporte': ['aporte'],
            'Resgate': ['resgate'],
            'Dividendos/Rendimentos': ['dividendo', 'rendimentos'],
        },
        'Transferências': {
            'Entre Contas': ['transferencia entre contas'],
            'PIX Enviado': ['pix enviado', 'pix'],
