...
HELP_TEXTS = {
    ...
    "lancamentos": (
        ...
        "🧾  <code>/fatura</code>\n"
        "   • Importe sua fatura do Inter em PDF e confirme os lançamentos em lote.\n\n"
        "📸  <b>Leitura Automática (OCR)</b>\n"
        "   • Dentro do comando <code>/lancamento</code>, envie uma <b>foto</b> e eu extraio os dados para você.\n"
        "   • Se enviar <b>PDF</b>, eu trato como <b>fatura</b> e importo os lancamentos em lote.\n\n"
    ...
    "planejamento": (
        ...
        "•  <code>/metas</code>\n"
        "   • Crie metas financeiras com plano mensal, progresso visual e check-in automatico.\n\n"
        "🗓️  <code>/agendar</code>\n"
        ...
        "💡  <b>Diferenciais das Metas:</b>\n"
        "   • 🧠 Plano mensal gerado por IA\n"
        "   • 📊 Progresso visual com percentuais\n"
        "   • 📅 Check-in mensal com confirmacao de aportes\n"
        "   • 🎯 Acompanhamento de progresso automatico\n"
        "   • 💰 Planejamento realista por mes"
    ),
    "config": (
        ...
        "   • <b>EXTINTOR DE INCÊNDIO!</b> Categoriza automaticamente TODOS os lançamentos sem categoria usando IA. Perfeito para corrigir falhas de categorização do OCR ou lançamento manual.\n\n"
    ...
    "gamificacao": (
        ...
        "📊  <code>/ranking</code>\n"
        "   • Consulte o <b>Hall da Fama Global</b> com ranking atualizado em tempo real.\n\n"
        "⭐  <b>Como ganhar XP:</b>\n"
        ...
        "   • 🔥 Multiplicadores de streak (ate +200% XP!)\n"
    ...
    "investimentos": (
        ...
        "✨  <b>Funcionalidades:</b>\n"
        # "   • 📈 Acompanhamento automático bancário\n"
