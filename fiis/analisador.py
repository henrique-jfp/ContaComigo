...
def explicar_conceito(conceito: str) -> str:
    ...
    mapa = {
        ...
        "dividend yield": "O DY (Dividend Yield) é quanto o fundo paga de rendimento em relação ao seu preço. Um DY de 10% significa que para cada R$100 investidos, você recebe R$10/ano em rendimentos. FIIs pagam mensalmente, então divide por 12: ~R$0,83 por mês para cada R$100 investidos.",
        ...
        "p/vp": "O P/VP compara o preço de mercado com o valor real dos ativos do fundo. P/VP < 1.0 = você está comprando R$1 de imóvel por menos de R$1 (desconto). P/VP > 1.2 = você está pagando prêmio acima do valor dos imóveis. Ideal: entre 0.9 e 1.1.",
        "valor patrimonial": "O P/VP compara o preço de mercado com o valor real dos ativos do fundo. P/VP < 1.0 = você está comprando R$1 de imóvel por menos de R$1 (desconto). P/VP > 1.2 = você está pagando prêmio acima do valor dos imóveis. Ideal: entre 0.9 e 1.1.",
        ...
        "vacancia": "Vacância é o percentual de imóveis do fundo que estão desocupados (sem gerar aluguel). Vacância 0% = 100% dos imóveis alugados, máxima eficiência. Vacância acima de 15% é sinal de alerta — menos receita, menos rendimento.",
        ...
        "imposto": "<b>Imposto de Renda em FIIs:</b>\n1. <b>Dividendos:</b> São ISENTOS de IR para pessoas físicas (desde que o fundo tenha +50 cotistas e seja listado em bolsa).\n2. <b>Venda com Lucro:</b> Se você vender suas cotas por um preço maior do que comprou, deve pagar 20% de imposto sobre o lucro através de uma DARF até o último dia útil do mês seguinte.",
        "lucro": "<b>Venda com Lucro em FIIs:</b> Diferente das ações, nos FIIs não há isenção de R$ 20 mil. Se vendeu com lucro, paga 20% de IR sobre o ganho. O pagamento deve ser feito via DARF (código 6015) até o final do mês seguinte à venda.",
        "reinvestir": "<b>O poder dos Juros Compostos:</b> Ao reinvestir seus dividendos para comprar novas cotas, você aumenta sua renda no mês seguinte (o 'efeito bola de neve'). Em média, se você reinvestir tudo por 10 anos, pode dobrar seu patrimônio apenas com a renda gerada.",
        "ir": "<b>Imposto de Renda em FIIs:</b>\n1. <b>Dividendos:</b> São ISENTOS de IR para pessoas físicas (desde que o fundo tenha +50 cotistas e seja listado em bolsa).\n2. <b>Venda com Lucro:</b> Se você vender suas cotas por um preço maior do que comprou, deve pagar 20% de imposto sobre o lucro através de uma DARF até o último dia útil do mês seguinte.",
        "isento": "Sim! Os rendimentos (dividendos) mensais dos FIIs são <b>isentos de Imposto de Renda</b> para investidores pessoa física, o que é uma das grandes vantagens desse investimento comparado a ações ou renda fixa tributada.",
        "isenção": "Sim! Os rendimentos (dividendos) mensais dos FIIs são <b>isentos de Imposto de Renda</b> para investidores pessoa física, o que é uma das grandes vantagens desse investimento comparado a ações ou renda fixa tributada.",
